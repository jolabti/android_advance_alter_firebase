...
public class MainActivity extends Activity {
    ...
    FirebaseDatabase firebaseDatabase; //bawaan firebase

    DatabaseReference databaseReference; //bawaan firebase
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseDatabase = FirebaseDatabase.getInstance(); // konstruktor
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                v.findViewById(R.id.update).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        customAdapter.notifyDataSetChanged();  // ini fungsi yang membuat si aplikasi merespon realtime
